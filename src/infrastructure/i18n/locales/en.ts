const en = {
  ...
  wh40k: {
    ...
    calculate: 'Calculate',
    mostLikelyDamage: 'Most likely damage',
    medianDamage: 'Median damage',
    expectedDamage: 'Avg. damage / round (long-term)',
    expectedRounds: 'Expected rounds to eliminate',
    killByRound: 'Cumulative elimination probability',
    round: 'Round {{n}}',
    probability: '{{p}}%',
  },
  combatHistory: {
