...
const es: Translations = {
  ...
  wh40k: {
    ...
    calculate: 'Calcular',
    mostLikelyDamage: 'Daño más probable',
    medianDamage: 'Daño mediano',
    expectedDamage: 'Media / ronda (largo plazo)',
    expectedRounds: 'Rondas esperadas para eliminar',
    killByRound: 'Probabilidad acumulada de eliminar',
    round: 'Ronda {{n}}',
    probability: '{{p}}%',
  },
  combatHistory: {
